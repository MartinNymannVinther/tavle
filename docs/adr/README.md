...
| [0007](0007-product-data-model.md)                 | The product's data model — six concepts and a record of moves                   | Amended by 0011                  |
...
| [0011](0011-one-backlog-structure.md)              | One backlog structure — a hierarchy that finishes, categories that never do     |                                  |
| [0012](0012-backlog-reads-as-sections.md)          | The backlog reads as sections, and every kind of thing has a symbol             |                                  |
...
| [0015](0015-story-map.md)                          | The story map is the decomposition's own view, computed from the board          | Amended by 0016                  |
| [0016](0016-story-map-backbone.md)                 | The story map has its own backbone — chosen features, in the story's order      | Amends 0015                      |
| [0017](0017-swimlanes.md)                          | Swimlanes on a Kanban board — three views and one field                         |                                  |
| [0018](0018-backlog-building-flow.md)              | Building the backlog is one surface, and rule 4 bites at the close              |                                  |
| [0019](0019-roadmap-interactive-spans.md)          | The roadmap's bars are the plan — a chosen start, moved and stretched in place  |                                  |
...
| [0032](0032-releases.md)                           | A release is the story map's band                                               |                                  |
| [0033](0033-one-rank-one-number.md)                | One rank, one number — a move writes one row                                    | Amends 0013                      |
